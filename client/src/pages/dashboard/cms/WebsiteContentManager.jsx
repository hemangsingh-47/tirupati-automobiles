  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        {/* Insurance Section */}
        <div className="bg-surface border border-white/5 rounded-2xl p-6 shadow-2xl">
          <h2 className="text-lg font-bold text-white mb-6 border-b border-white/10 pb-4">Insurance Section Text</h2>
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray mb-1">Title</label>
              <input type="text" {...register('insuranceTitle')} className="w-full bg-background border border-white/10 rounded-lg px-4 py-2 text-white outline-none focus:border-primary" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray mb-1">Description</label>
              <textarea {...register('insuranceDescription')} rows="4" className="w-full bg-background border border-white/10 rounded-lg px-4 py-2 text-white outline-none focus:border-primary resize-none"></textarea>
            </div>
          </div>
        </div>
