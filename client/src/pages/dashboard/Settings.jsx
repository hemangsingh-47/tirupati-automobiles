...
const Settings = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      await api.patch('/settings', formDataToSend, {
        headers: {
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-surface border border-white/5 rounded-2xl p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray mb-1">Upload Logo</label>
                <input 
                  type="file"
                  name="logo"
                  accept="image/*"
                  onChange={handleChange}
                  className="w-full bg-background border border-white/10 rounded-lg px-4 py-2 text-white focus:border-primary outline-none file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-background hover:file:bg-yellow-500"
                />
                {formData.logo && !logoFile && (
                  <img src={formData.logo} alt="Current Logo" className="mt-2 h-12 object-contain" />
                )}
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface border border-white/5 rounded-2xl p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray mb-1">YouTube URL</label>
                <input 
                  name="youtube"
              ...
              <div>
                <label className="block text-sm font-medium text-gray mb-1">LinkedIn URL</label>
                <input 
                  name="linkedin"
