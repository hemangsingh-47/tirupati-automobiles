...
const InsuranceClaim = () => {
  return (
    <main>
      <PageHero 
        title="Insurance Claim & Renewal" 
        description="Experience a completely stress-free, 100% cashless insurance claim process or renew your existing policy with the best quotes."
      ...
      <section className="py-12 bg-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-bold font-heading text-background mb-2">Is your vehicle insurance expiring soon?</h2>
            <p className="text-background/80 font-medium">Renew it easily through our portal and get the best quotes from top providers.</p>
          </div>
          <Link 
            to="/customer/insurance/renew" 
            className="px-8 py-4 bg-background text-primary font-bold rounded-lg hover:bg-surface hover:text-white transition-colors whitespace-nowrap shadow-xl"
          >
            Renew Insurance Now
          </Link>
        </div>
