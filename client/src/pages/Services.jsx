            ...
            {services?.map((service, index) => (
              ...
              >
                <div className="h-48 overflow-hidden relative">
                  ...
                  <img 
                    src={service.imageUrl ? getUploadUrl(service.imageUrl) : 'https://images.unsplash.com/photo-1632823462996-e251a34005aa?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'} 
                    alt={service.title} 
