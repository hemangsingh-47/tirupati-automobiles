...
import { CarFront, Clock, FileText, CheckCircle2, ArrowLeft, Image as ImageIcon, MessageCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {settings?.whatsapp && (
          <a 
            href={getWhatsAppUrl(settings.whatsapp, `Hello, I need help with my booking. Booking ID: ${booking._id?.slice(-8).toUpperCase()}`)}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20 px-4 py-2 rounded-lg font-medium hover:bg-[#25D366] hover:text-white transition-colors"
          >
