...
import { getWhatsAppUrl, getBookingMessage } from '../utils/contactUtils';
            ...
            {successData ? (
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                  <a 
                    href={getWhatsAppUrl(settings?.whatsapp, getBookingMessage(successData))}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold px-8 py-4 rounded-lg hover:bg-[#128C7E] transition-colors"
                  >
                    Send Booking Details via WhatsApp
                  </a>
                  <Link to="/" className="inline-block bg-surface border border-white/10 text-white font-bold px-8 py-4 rounded-lg hover:bg-white/5 transition-colors">
                    Return to Home
                  </Link>
                </div>
              </motion.div>
