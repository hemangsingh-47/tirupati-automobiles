              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-6 bg-surface border border-white/5 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray text-sm leading-relaxed">{settings?.phone || '+91 98765 43210'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-6 bg-surface border border-white/5 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray text-sm leading-relaxed">{settings?.email || 'info@tirupatiautomobiles.com'}</p>
                  </div>
                </div>
